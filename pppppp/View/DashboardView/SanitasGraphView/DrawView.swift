...
class DrawView: UIView {
    ...
    var personalPathView: PersonalPathView?
...
//            personalPathView?.graph(vertex: CGPoint(x: x, y: y), item: item)
//            personalPathView?.configure(rect: <#T##CGRect#>, friendListItems: <#T##UserData#>)
//            self.addSubview(personalPathView!)
        }
    }
