...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let pointViewClear = ImageAsset(name: "PointView-clear")
    ...
    internal static let sanitasCard = ImageAsset(name: "sanitasCard")
    internal static let sanitasLogo = ImageAsset(name: "sanitasLogo")
  }
  internal enum Colors {
    ...
    internal static let gradientBlue1 = ColorAsset(name: "gradient_blue_1")
    ...
    internal static let onboardingGradientColor1 = ColorAsset(name: "onboardingGradientColor1")
    internal static let onboardingGradientColor2 = ColorAsset(name: "onboardingGradientColor2")
